...
import { CrewSessionScreen } from "@/src/features/crew";

export default function CrewSessionRoute() {
  ...
  return <CrewSessionScreen crewId={parsedCrewId} sessionId={parsedSessionId} />;
}
